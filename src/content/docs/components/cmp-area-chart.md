...
Reusable Power Apps Canvas area chart component with configurable layout, KPI, axes, colors, and data. Download the original
definition, import it into Power Apps Studio, and customize its properties for your app.

<div class="component-actions">
  <a href="/Power-Platform-Content/downloads/components/cmp-area-chart.yml" download="cmp-area-chart.yml">Download YAML source</a>
      ...
      Config:
        ...
        Default: |-
          ={
            ...
            Title:{ Text:"Area chart", H:26, Gap:12 },
          ...
          With(
            {
              ...
              titleText: Coalesce(cfg.Title.Text, "Area chart"),
              ...
              areaOpacity: Coalesce(cfg.Area.Opacity, 0.45),
              ...
              cArea: Coalesce(t.Colors.AreaFill, "#D9D9D9"),
                ...
                With(
                  ...
                  With(
                    ...
                    },
                    {
                      ...
                      LineClr:cLine, AreaFill:cArea, AreaOpacity:areaOpacity,
                      LegendText:cLegend,
              ...
              <svg xmlns='http://www.w3.org/2000/svg' width='{M.W}' height='{M.H}' viewBox='0 0 {M.W} {M.H}'>
                ...
                <defs>
                  <linearGradient id='areaGrad' x1='0' y1='0' x2='0' y2='1'>
                    <stop offset='0%'   stop-color='{M.AreaFill}' stop-opacity='{Text(M.AreaOpacity,"[$-en-US]0.0")}'/>
                    <stop offset='100%' stop-color='{M.AreaFill}' stop-opacity='0'/>
                  </linearGradient>
                </defs>
                ...
                <polygon fill='url(#areaGrad)'
                  points='{
                    If(
                      n > 0,
                      Text(M.PlotX,"[$-en-US]0.0") & "," & Text(M.AxisY,"[$-en-US]0.0") & " " &
                      Concat(
                        Sequence(n) As i,
                        With(
                          ...
                          With(
                            ...
                            Text(px,"[$-en-US]0.0") & "," & Text(py,"[$-en-US]0.0") & " "
                          )
                        )
                      ) &
                      Text(M.PlotX + ((n - 1) * M.StepX),"[$-en-US]0.0") & "," & Text(M.AxisY,"[$-en-US]0.0"),
                      ""
                    )
                  }' />

                <!-- LINE (polyline) -->
                <polyline fill='none' stroke='{M.LineClr}' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'
                  points='{
                    Concat(
                      Sequence(n) As i,
                      With(
                ...
                <text x='{Text(lx + M.Box + M.BoxGap,"[$-en-US]0.0")}' y='{Text(ly,"[$-en-US]0.0")}'
                  ...
                  {Substitute(r.lbl, "&", "and")}: {Text(r.val, "[$-en-US]0.##")}
                </text>
                              "
                            )
                          )
