...
Reusable Power Apps Canvas area chart component with configurable layout, KPI, axes, colors, and data. Download the original definition and use it with a component
