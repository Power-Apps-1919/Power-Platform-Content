...
template: splash
hero:
  tagline: A curated toolkit for building better Power Apps.
  actions:
    - text: Explore components
      link: /Power-Platform-Content/components/
      icon: right-arrow
      variant: primary
    - text: Browse the blog
      link: /Power-Platform-Content/blog/get-app-id-dynamically/
      icon: external
      variant: minimal
---

import ContentDashboard from '../../components/ContentDashboard.astro';

<div class="hero-kicker">POWER PLATFORM / BUILD SYSTEM</div>

Welcome to a living library of practical patterns, reusable Canvas App components,
and notes from the field. Everything is versioned, downloadable, and ready to adapt.

<div class="section-intro">
  <span class="section-label">01 / WHAT'S INSIDE</span>
...
<div class="download-strip">
  ...
  <a href="/Power-Platform-Content/downloads/components/cmp-card-control.yml" download="cmp-card-control.yml">Download Card Control</a>
</div>
