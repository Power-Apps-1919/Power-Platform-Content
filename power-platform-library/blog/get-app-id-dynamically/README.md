...
1. Create an **Instant cloud flow** with the trigger **When Power Apps calls a flow (V2)**.
   ...
   <figure>
     <img src="./images/01-trigger.png" alt="Power Automate trigger: When Power Apps calls a flow (V2)" width="1200" />
...
2. Add three **Compose** actions named `Compose - App ID`, `Compose - Environment ID`, and `Compose - Tenant ID`.
   ...
   <figure>
     <img src="./images/02-composeall.png" alt="Three Compose actions for App ID, Environment ID, Tenant ID" width="1200" />
...
3. In each Compose, paste these expressions:
   ...
   **App ID**
   ...
   <figure>
     <img src="./images/03-compose-appid.png" alt="Expression for App ID in a Compose action" width="1200" />
   ...
   **Environment ID**
   ...
   <figure>
     <img src="./images/04-compose-env.png" alt="Expression for Environment ID in a Compose action" width="1200" />
   ...
   **Tenant ID**
   ...
   <figure>
     <img src="./images/05-compose-tenant.png" alt="Expression for Tenant ID in a Compose action" width="960" />
...
4. Add **Respond to a PowerApp or flow** that returns `{ App_ID, Environment_ID, Tenant_ID }` mapped from the three Compose outputs.
   ...
   <figure>
     <img src="./images/06-respondtoapp.png" alt="Respond to a PowerApp or flow returning the IDs" width="1200" />
